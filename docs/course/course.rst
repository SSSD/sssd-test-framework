...
See :doc:`../running-tests` to se how to prepare the environment and run the
tests.
...
.. dropdown:: Task 1
    ...
    .. dropdown:: Display hints
        ...
        * :doc:`../writing-tests`
        * :class:`sssd_test_framework.topology.KnownTopology`
...
.. dropdown:: Task 2
    ...
    .. dropdown:: Display hints
        ...
        * :class:`sssd_test_framework.topology.KnownTopology`
        * :class:`sssd_test_framework.roles.base.BaseLinuxRole`
        * :class:`sssd_test_framework.roles.ldap.LDAP`
        * :class:`sssd_test_framework.roles.client.Client`
        * :class:`sssd_test_framework.utils.sssd.SSSDUtils`
...
.. dropdown:: Task 7
    ...
    .. dropdown:: Display hints
        ...
        * :class:`sssd_test_framework.roles.client.Client`
        * :class:`sssd_test_framework.utils.sssd.SSSDUtils`
        * :class:`sssd_test_framework.utils.authentication.AuthenticationUtils`
...
.. dropdown:: Task 10
    ...
    .. dropdown:: Display hints
        ...
        * :class:`sssd_test_framework.roles.client.Client`
        * :class:`sssd_test_framework.utils.sssd.SSSDUtils`
        * :meth:`sssd_test_framework.utils.sssd.SSSDCommonConfiguration.sudo`
        * :class:`sssd_test_framework.utils.authentication.AuthenticationUtils`
        * :class:`sssd_test_framework.utils.authselect.AuthselectUtils`
    ...
    .. dropdown:: Display solution
        ...
        .. note::
            ...
            from SSSD. You can use :meth:`sssd_test_framework.utils.sssd.SSSDCommonConfiguration.sudo`
...
.. dropdown:: Task 27
    ...
    .. dropdown:: Display hints
        ...
        * :doc:`../writing-tests`
        * :doc:`../guides/testing-identity`
        * :class:`sssd_test_framework.topology.KnownTopologyGroup`
        * :class:`sssd_test_framework.roles.base.BaseLinuxRole`
        * :class:`sssd_test_framework.roles.generic.GenericProvider`
        * :class:`sssd_test_framework.roles.client.Client`
        * :class:`sssd_test_framework.utils.sssd.SSSDUtils`
        * :class:`sssd_test_framework.utils.tools.LinuxToolsUtils`
...
.. dropdown:: Task 28
    ...
    .. dropdown:: Display hints
        ...
        * :class:`sssd_test_framework.topology.KnownTopologyGroup`
        * :class:`sssd_test_framework.roles.base.BaseLinuxRole`
        * :class:`sssd_test_framework.roles.generic.GenericADProvider`
        * :class:`sssd_test_framework.roles.client.Client`
        * :class:`sssd_test_framework.utils.sssd.SSSDUtils`
        * :class:`sssd_test_framework.utils.tools.LinuxToolsUtils`
