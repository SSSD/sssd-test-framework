...
class KeycloakHost(BaseDomainHost, BaseLinuxHost):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.client.setdefault("enabled", "true")
        self.client.setdefault("idp_type", "keycloak:https://master.keycloak.test:8443/auth/admin/realms/master/")
        self.client.setdefault("auto_private_groups", "true")
        self.client.setdefault("use_fully_qualified_names", "true")
        self.client.setdefault("debug_level", "9")
