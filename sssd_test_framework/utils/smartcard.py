...
class SmartCardUtils(MultihostUtility[MultihostHost]):
    ...
    def __init__(self, host: MultihostHost, fs: LinuxFileSystem, svc: SystemdServices) -> None:
        ...
        :param fs: Filesystem utility instance.
        :type fs: LinuxFileSystem
        :param svc: Systemd svc utility instance.
    ...
    def init(self, label: str = "sc_test", so_pin: str = "12345678", user_pin: str = "123456") -> None:
        ...
        self.fs.mkdir(self.TOKEN_STORAGE_PATH)
        ...
        command_line = self.cli.command("softhsm2-util --init-token", args)
        self.host.conn.run(command_line, env={"SOFTHSM2_CONF": self.SOFTHSM2_CONF_PATH})
    ...
    def add_key(self, key_path: str, key_id: str = "01", pin: str = "123456") -> None:
        ...
        args: CLIBuilderArgs = {
            ...
            "write-object": (self.cli.option.VALUE, key_path),
            "type": (self.cli.option.VALUE, "privkey"),
            "id": (self.cli.option.VALUE, key_id),
        }
        command_line = self.cli.command("pkcs11-tool", args)
        self.host.conn.run(command_line, env={"SOFTHSM2_CONF": self.SOFTHSM2_CONF_PATH})
    ...
    def add_cert(self, cert_path: str, cert_id: str = "01", pin: str = "123456") -> None:
        ...
        args: CLIBuilderArgs = {
            ...
            "type": (self.cli.option.VALUE, "cert"),
    ...
    def generate_self_signed_cert(
        ...
        command_line = self.cli.command("openssl req", args)
        self.host.conn.run(command_line)
