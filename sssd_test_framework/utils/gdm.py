...
class GDM(MultihostUtility[MultihostHost]):
    ...
    def login_idp(self, client: Client, username: str, password: str, close: bool = True) -> bool:
        """
        ...
        :type password: str
        :param close: Determine whether or not to execute done function, optional
        :type close: bool, defaults to True
