...
class SudoRuleDefaults:
    """
    Default values for sudo rules.
    """
...
class LocalSudoRule(object):
    ...
    def add(
        self,
        *,
        user: str | LocalUser | LocalGroup | list[str | LocalUser | LocalGroup] | Any | None = SudoRuleDefaults.user,
        host: str | list[str] | Any | None = SudoRuleDefaults.host,
        command: str | list[str] | Any | None = SudoRuleDefaults.command,
