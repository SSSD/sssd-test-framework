...
class ADComputer(ADObject):
    ...
    def __init__(self, role: AD, name: str, basedn: ADObject | str | None = "cn=computers") -> None:
        ...
        :type basedn: ADObject | str | None, optional
        """
        super().__init__(role, "Object", name, f"cn={name}", basedn, default_ou=None)
...
class GPO(BaseObject[ADHost, AD]):
    ...
    def policy(self, logon_rights: dict[str, list[ADObject]], cfg: dict[str, str] | None = None) -> GPO:
        """
        ...
        :type cfg: dict[str, str] | None, optional
        :return: Group policy object
        :rtype: GPO
        """
        _keys: list[str] = [
