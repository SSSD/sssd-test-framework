...
class AD(BaseWindowsRole[ADHost]):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        .. code-block:: python
            ...
            # Request a smartcard certificate
            cert, key, csr = ad.ca.request_smartcard(
                ...
                requester_name="AD\\Administrator"
            )
...
class ADCertificateAuthority(GenericCertificateAuthority):
    ...
    .. code-block:: python
       :caption: Smartcard certificate request and revocation.

       # Smartcard certificate request (primary use case)
       cert, key, csr = ad.ca.request(
           template="SmartcardLogon",
           subject="CN=testuser",
           enrollment_agent_cert_hash="abc123...",
    ...
    def __init__(self, host: ADHost) -> None:
        ...
        self.host = host
        self.cli = host.cli
        self.temp_dir = f"C:\\temp\\ad_test_certs_{os.getpid()}_{uuid.uuid4().hex}"
    ...
    """
        ...
        {inf_content}
        "@
            Set-Content -Path "{inf_path}" -Value $content
            """
        )
    ...
    def request(
       ...
       """
        ...
        result = self.host.conn.run(
            f'certreq -sign -cert "{enrollment_agent_cert_hash}" "{req_path}" "{signed_req_path}"',
            raise_on_error=False,
        )
        if result.rc != 0:
    ...
    def get_certificate_template(self, template_name: str) -> dict[str, list[str]]:
        ...
        return self._parse_ad_object_info(result.stdout)
    ...
    def _parse_ad_object_info(self, output: str) -> dict[str, list[str]]:
        """
