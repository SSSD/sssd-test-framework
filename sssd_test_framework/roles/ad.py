...
class ADCertificateAuthority(GenericCertificateAuthority):
    ...
    def _setup_enrollment_agent(self) -> None:
        ...
        If the EnrollmentAgent template is not available or submission/acceptance fails,
        this method silently returns and :meth:`request` will fall back to
        :meth:`request_basic`. Raises :class:`RuntimeError` if the initial CSR
        creation fails, as that indicates a configuration problem.
        """
