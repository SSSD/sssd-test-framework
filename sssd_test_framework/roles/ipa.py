...
class IPA(BaseLinuxRole[IPAHost]):
    ...
    def dns(self) -> IPADNSServer:
        ...
        .. code-block:: python
            ...
            ipa.dns().add_forwarders("1.1.1.1")

            # Remove a global forwarder
            ipa.dns().remove_forwarders("1.1.1.1")
        """
...
class IPADNSServer(BaseObject[IPAHost, IPA]):
    ...
    def list_zones(self) -> list[str] | None:
        ...
        if result is None:
            ...
            parsed_result = attrs_parse_ipa(zones, ["idnsname"])
...
class IPADNSZone(IPADNSServer):
    ...
    def add_record(self, shortname: str, ip: str) -> IPADNSZone:
        """
        Add DNS record.
        ...
        :rtype: IPADNSZone
        """
        record_type = "aaaa-rec" if ":" in ip else "a-rec"
