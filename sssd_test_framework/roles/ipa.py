...
class IDUserOverride(IPAUser):
    ...
    def add_override(
        ...
        idview_name: str,
        *,
        description: str | Mapping[str, int | str] | None = None,
        login: str | Mapping[str, int | str] | None = None,
        uid: int | Mapping[str, int | str] | None = None,
        gid: int | Mapping[str, int | str] | None = None,
        gecos: str | Mapping[str, int | str] | None = None,
        home: str | Mapping[str, int | str] | None = None,
        shell: str | Mapping[str, int | str] | None = None,
        sshpubkey: str | Mapping[str, int | str] | None = None,
        certificate: str | Mapping[str, int | str] | list[str] | None = None,
        **kwargs: str | int,
    ) -> list[ProcessResult[ProcessError] | list[str] | str | Mapping[str, int | str] | list[Any] | None]:
        """
